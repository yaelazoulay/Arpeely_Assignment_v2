...
_SUMMARY_PATH = _ROOT / "docs" / "metrics-rationale-summary.md"
...
- **Written summary** (1–2 paragraphs): expander *Summary* at top of this page, or file `task2_analytics/docs/metrics-rationale-summary.md` in the repo.
        """
    )
